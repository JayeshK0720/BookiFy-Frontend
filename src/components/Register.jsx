    ...
    return (
        <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
            <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
                <h2 className='text-xl font-semibold mb-4'>Please Register Yourself</h2>
                ...
                <div className='mt-4'>
                    <button
                        ...
                        className='w-full flex flex-wrap gap-1 items-center justify-center bg-[var(--secondary)] hover:bg-blue-700 text-white font-bold 
